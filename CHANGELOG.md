...
- The AceStep installer now validates external command failures properly, auto-detects or falls back across common branch names, and reports checkout-layout issues more clearly when upstream changes break the expected build root.
