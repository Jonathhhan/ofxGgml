...
common:
	...
	ADDON_SOURCES_EXCLUDE += libs/ggml/build-probe-devcmd-cuda-toolset/%
	ADDON_SOURCES_EXCLUDE += libs/ggml/build-probe-devcmd-no-toolset/%
	ADDON_SOURCES_EXCLUDE += libs/ggml/build-probe-nmake-cuda-vulkan/%
	ADDON_SOURCES_EXCLUDE += libs/ggml/build-probe-no-toolset/%
	ADDON_SOURCES_EXCLUDE += libs/ggml/build-probe-vs-host-toolset/%
	ADDON_SOURCES_EXCLUDE += libs/ggml/build-probe-vs-x64-no-toolset/%
	...
	ADDON_SOURCES_EXCLUDE += libs/sam3.cpp/build-cpu/%
	...
	ADDON_INCLUDES_EXCLUDE += libs/ggml/build-probe-devcmd-cuda-toolset/%
	ADDON_INCLUDES_EXCLUDE += libs/ggml/build-probe-devcmd-no-toolset/%
	ADDON_INCLUDES_EXCLUDE += libs/ggml/build-probe-nmake-cuda-vulkan/%
	ADDON_INCLUDES_EXCLUDE += libs/ggml/build-probe-no-toolset/%
	ADDON_INCLUDES_EXCLUDE += libs/ggml/build-probe-vs-host-toolset/%
	ADDON_INCLUDES_EXCLUDE += libs/ggml/build-probe-vs-x64-no-toolset/%
	...
	ADDON_INCLUDES_EXCLUDE += libs/sam3.cpp/build-cpu/%
